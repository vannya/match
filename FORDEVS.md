## This project is still a work in progress.  However, if you would like to try to run on dev, here's the process:   

# To run on dev: 

**First time setup**
Open your command terminal and navigate to the folder you want to install in.  
Type ```git clone https://github.com/vannya/modmemes.git```.  
